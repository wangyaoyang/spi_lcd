...
${OBJECTDIR}/lcd/lcd_author_name.o: lcd/lcd_author_name.c
	...
	${RM} "$@.d"
	$(COMPILE.c) -O2 -Iinclude -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/lcd/lcd_author_name.o lcd/lcd_author_name.c

${OBJECTDIR}/lcd/lcd_ili9341.o: lcd/lcd_ili9341.c
	${MKDIR} -p ${OBJECTDIR}/lcd
	${RM} "$@.d"
	$(COMPILE.c) -O2 -Iinclude -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/lcd/lcd_ili9341.o lcd/lcd_ili9341.c

${OBJECTDIR}/lcd/lcd_ili9341_font.o: lcd/lcd_ili9341_font.c
	${MKDIR} -p ${OBJECTDIR}/lcd
	${RM} "$@.d"
	$(COMPILE.c) -O2 -Iinclude -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/lcd/lcd_ili9341_font.o lcd/lcd_ili9341_font.c

${OBJECTDIR}/lcd/lcd_ili9341_font_brandname_eng.o: lcd/lcd_ili9341_font_brandname_eng.c
	${MKDIR} -p ${OBJECTDIR}/lcd
	${RM} "$@.d"
	$(COMPILE.c) -O2 -Iinclude -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/lcd/lcd_ili9341_font_brandname_eng.o lcd/lcd_ili9341_font_brandname_eng.c

${OBJECTDIR}/lcd/lcd_ili9341_image_logo.o: lcd/lcd_ili9341_image_logo.c
	${MKDIR} -p ${OBJECTDIR}/lcd
	${RM} "$@.d"
	$(COMPILE.c) -O2 -Iinclude -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/lcd/lcd_ili9341_image_logo.o lcd/lcd_ili9341_image_logo.c

${OBJECTDIR}/lcd/lcd_omcj4x8c_16.o: lcd/lcd_omcj4x8c_16.c
	${MKDIR} -p ${OBJECTDIR}/lcd
	${RM} "$@.d"
	$(COMPILE.c) -O2 -Iinclude -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/lcd/lcd_omcj4x8c_16.o lcd/lcd_omcj4x8c_16.c

${OBJECTDIR}/lcd/lcd_omcj4x8c_font.o: lcd/lcd_omcj4x8c_font.c
	${MKDIR} -p ${OBJECTDIR}/lcd
	${RM} "$@.d"
	$(COMPILE.c) -O2 -Iinclude -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/lcd/lcd_omcj4x8c_font.o lcd/lcd_omcj4x8c_font.c

${OBJECTDIR}/lcd/lcd_spi.o: lcd/lcd_spi.c
	${MKDIR} -p ${OBJECTDIR}/lcd
	${RM} "$@.d"
	$(COMPILE.c) -O2 -Iinclude -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/lcd/lcd_spi.o lcd/lcd_spi.c

${OBJECTDIR}/lcd/touch_ads7843.o: lcd/touch_ads7843.c
	${MKDIR} -p ${OBJECTDIR}/lcd
	${RM} "$@.d"
	$(COMPILE.c) -O2 -Iinclude -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/lcd/touch_ads7843.o lcd/touch_ads7843.c
